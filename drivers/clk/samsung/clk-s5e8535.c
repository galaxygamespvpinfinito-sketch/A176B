...
/* CMU_G3D */
struct init_vclk s5e8535_g3d_vclks[] = {
	VCLK(DOUT_DIV_CLK_G3D_NOCP, DIV_CLK_G3D_NOCP, "DIV_CLK_G3D_NOCP", 0, 0, NULL),
	VCLK(MOUT_CLKCMU_G3D_NOC_USER, MUX_CLKCMU_G3D_NOC_USER, "MOUT_CLKCMU_G3D_NOC_USER", 0, 0, NULL),
};
...
static int s5e8535_clock_probe(struct platform_device *pdev)
{
	...
	samsung_register_vclk(s5e8535_clk_provider, s5e8535_g3d_vclks, ARRAY_SIZE(s5e8535_g3d_vclks));
