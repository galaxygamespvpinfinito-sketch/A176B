...
#include "is-vender.h"
#include "is-time.h"
#ifdef USE_MUTEX_IN_SENSOR_NORMAL_ON
#include "is-core.h"
#endif
...
#ifdef USE_MUTEX_IN_SENSOR_NORMAL_ON
	core = is_get_is_core();
	if (scenario == SENSOR_SCENARIO_NORMAL && gpio_scenario == GPIO_SCENARIO_ON)
		mutex_lock(&core->powerseq_lock);
#endif
...
#ifdef USE_MUTEX_IN_SENSOR_NORMAL_ON
	if (scenario == SENSOR_SCENARIO_NORMAL && gpio_scenario == GPIO_SCENARIO_ON)
		mutex_unlock(&core->powerseq_lock);
#endif
p_err:
	return ret;
}
